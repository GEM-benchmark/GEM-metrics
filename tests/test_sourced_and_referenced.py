...
class SourcedAndReferencedMetricTest(object):
    ...
    def test_metric(self):
        ...
        assertDeepAlmostEqual(self, calculated_metrics, self.expected_result_basic, places=SourcedAndReferencedMetricTest.test_precision)
    ...
    def test_metric_identical_pred_ref(self):
        ...
        assertDeepAlmostEqual(self, calculated_metrics, self.expected_result_identical_pred_ref, places=SourcedAndReferencedMetricTest.test_precision)
    ...
    def test_metric_mismatched_pred_ref(self):
        ...
        assertDeepAlmostEqual(self, calculated_metrics, self.expected_result_mismatched_pred_ref, places=SourcedAndReferencedMetricTest.test_precision)
    ...
    def test_metric_mismatched_empty_tgt(self):
        ...
        assertDeepAlmostEqual(self, calculated_metrics, self.expected_result_empty_pred_ref, places=SourcedAndReferencedMetricTest.test_precision)
